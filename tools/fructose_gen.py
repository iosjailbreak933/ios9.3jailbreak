...
Modified      2014 by Filip Szufnarowski <kofnarson@gmail.com>
...
def generate_main(test_files):
    ...
    for test_file in test_files:
        print ('%sprintf("### Tests in %s\\n");'
               % (INDENT, test_file.filename))
        for test_class in test_file.test_classes:
            print ('%sprintf(" -> Testing of %s:\\n");'
                   % (INDENT, test_class.name))
